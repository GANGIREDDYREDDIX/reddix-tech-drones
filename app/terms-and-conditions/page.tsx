        ...
        <div className={styles.contentCard}>
          ...
          <div className={styles.sections}>
            <section className={styles.section}>
              <h2>
                <span className={styles.sectionNumber}>1.0</span> FPV Rules and Regulations
              </h2>
              <p>
            ...
            <section className={styles.section}>
              <h2>
                <span className={styles.sectionNumber}>2.0</span> Warning Notice
              </h2>
              <p>
            ...
            <section className={styles.section}>
              <h2>
                <span className={styles.sectionNumber}>3.0</span> No Warranty/Liability
              </h2>
              <p>
              ...
              <ul className={styles.sectionList}>
                <li><strong>Specifications, prices, and availability</strong> can change without notice and might not always be immediately updated on the product page. For the most current information, please contact Reddix customer service directly.</li>
                <li>If you receive a product with <strong>specifications different from what was listed on our site</strong>, please tell us <strong>before</strong> you install or mount it. We cannot be held responsible for any damages if you proceed with installation, nor can we offer support in such cases.</li>
                <li><strong>Product images</strong> may sometimes be outdated. Manufacturers often change designs or features without informing us, and we may not always have the latest image. We will not accept returns based solely on an image being different unless the product description is also incorrect. <strong>Product descriptions take precedence over images.</strong> For example, if an image shows a blue radio but you selected pink, you will receive the pink one.</li>
              </ul>
              <p>
            ...
            <section className={styles.section}>
              <h2>
                <span className={styles.sectionNumber}>4.0</span> Returns
              </h2>
              <p>
            ...
            <section className={styles.section}>
              <h2>
                <span className={styles.sectionNumber}>5.0</span> Shipping Terms and Conditions
              </h2>
              
              <h3>5.1 Commercial Carriers</h3>
              <p>
              ...
              <h3>5.3 Tracking and Lost Shipments</h3>
              <p>
              ...
              <h3>5.5 Signature requirements</h3>
              <p>
              ...
              <h3>5.7 Canceled Order Refunds</h3>
              <p>
              ...
              <h3>5.8 Shipment Times and Delays</h3>
              <p>
              ...
              <h3>5.10 Fraudulent Activity</h3>
              <p>
              ...
              <p>
                <strong>In any case, Reddix reserves the right to take the final decision after checking with the stakeholders. Please do not order with us if you are not comfortable with this condition!</strong>
              </p>
            </section>

            <section className={styles.section}>
              <h2>
                <span className={styles.sectionNumber}>6.0</span> B2B GST Credit Invoice
              </h2>
              <p>
                We provide B2B GST Invoices for customers with a valid GST number. Since our systems are automated, you will need to add your GST number during checkout in the relevant fields where asked. Unfortunately, if the customer forgets to add this/inputs incorrect GST number, <strong>we will not be able to amend it in any case</strong> and the invoice will be considered as a B2C invoice without GST credit.
              </p>
            </section>
          </div>
